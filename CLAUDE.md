...
- Bash (POSIX + bashisms), Markdown (Claude Code slash commands) + Claude Code CLI, Codex CLI (MCP server), speckit (`.specify/`) (018-unify-review-ledger)
- File-based — `specs/<feature>/review-ledger-{spec,plan}.json`, `specs/review-dashboard.md` (018-unify-review-ledger)
- Markdown (Claude Code slash commands) + Bash + Claude Code CLI, AskUserQuestion tool, specflow slash commands (019-autofix-loop-reliability)
- File-based — `specs/<feature>/review-ledger.json` (read-only for this feature) (019-autofix-loop-reliability)
- File-based — Markdown, JSON, shell scripts (020-openspec-migration)
