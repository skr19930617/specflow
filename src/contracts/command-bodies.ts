...
export const commandBodies: Record<string, CommandBody> = {
  ...
  "specflow.design": {
    ...
    sections: [
      ...
      {
        title: "Step 5: Codex Design Review",
  ...
  "specflow": {
    ...
    sections: [
      ...
      {
        title: "Step 3: Create Change + Proposal via OpenSpec",
