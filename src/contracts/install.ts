import { AssetType, type ContractsBundle, type InstallCopyContract, type InstallLinkContract, type InstallSettingsMergeContract } from "../types/contracts.js";
...
const installLinks: readonly InstallLinkContract[] = orchestratorContracts.map((orchestrator) => ({
