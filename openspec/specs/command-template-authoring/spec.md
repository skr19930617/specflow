# command-template-authoring Specification

## Purpose
TBD - created by archiving change refactor-command-bodies-into-template-based-authoring-with-explicit-contract-insertion-points. Update Purpose after archive.
## Requirements
